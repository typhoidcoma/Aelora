...
| **Discord Activity Integration** | Removed | Discord Activity support (ThreeJS/Unity iframe, OAuth2 flow, `/play` slash command, Character/Activity dashboard subtab) was removed. |
